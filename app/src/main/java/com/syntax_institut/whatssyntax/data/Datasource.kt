...
class Datasource {
    ...
    private val contactList = listOf(
        Contact("Anna Smith", "123-456-7890", R.drawable.pp_02, Status("Habe Steinpilze abzugeben.",R.drawable.christine_siracusa_xjy1c5lvnn8_unsplash)),
        Contact("John Doe", "321-654-0987", R.drawable.pp_01, null),
        ...
        Contact("Mike Davis", "246-135-7920", R.drawable.pp_01, Status("Schönes Wetter heute!",R.drawable.wetter)),
        Contact("Lena Wilson", "654-987-3210", R.drawable.pp_05, null),
        ...
        Contact("Laura Reed", "999-888-7777", R.drawable.pp_03, null),
        Contact("John Hall", "000-999-8888", R.drawable.pp_01, null),
